...
public class UIvsDatabaseValidation {
	...
	@Given("user retrieves all data from the ui")
	public void user_retrieves_all_data_from_the_ui() {
		System.out.println("user retreives values from ui table");
	    
	}

	@Given("user retrieves all the data from database using below query")
	...
	public void user_validates_that_drop_down_contains_following_values(List<String> ddValues) {
	// retrieve values from UI --> user interface
		for (int i=0; i< ddValues.size(); i++) {
		System.out.println(ddValues.get(i));
	}	
	...
	public void user_add_the_following_employees_and_and_LastName_and_click_on_save_btn( DataTable dTable) {
